        ...
        for sub_id in range(sub_start, sub_end):
            ...
            for trial_id in range(1, 4):
                for cam_id in range(1, 3):
                    if os.path.exists(f'dataset/Activity{act_id}/Subject{sub_id}/Trial{trial_id}Cam1.png'):
                        args = ['--coco_points', f'--video=dataset/Activity{act_id}/Subject{sub_id}/Trial{trial_id}Cam{cam_id}.png']
